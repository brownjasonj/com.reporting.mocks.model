...
public class IRVega extends Risk {
    /*
 ...
 */
    ...
    public IRVega(MarketEnvId marketEnvId,
                String bookName,
                Tcn tcn,
                List<String> bucketNames) {
        super(RiskKind.SINGLE, RiskType.IRVEGA, marketEnvId, bookName, tcn);
